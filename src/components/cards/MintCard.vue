  ...
  >
    ...
    >
      ...
      <p class="text-base text-white font-semibold" v-if="cardtype == 'mint'">
        Ready to create your NFT? <br class="hidden lg:block" />
        Minting is IRREVERSABLE
      </p>
      <button
        @click="MintIt"
        v-if="cardtype == 'mint'"
    ...
    >
      ...
      <span class="text-base leading-6 font-semibold text-white">
        We will review your changes and send it back for you to MINT your NFT
        Assets. You may also contact us below
      </span>
      <button
        @click="Revision"
        class="
