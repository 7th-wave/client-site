<template>
    <div class="inline-flex items-center justify-center w-full h-16 border-t border-gray-200">
            ...
            <div class="inline-flex flex-col items-start justify-start">
                ...
                <div class="inline-flex items-end justify-start">
                    <div class="flex space-x-2 items-end justify-start">
                        <p class="text-lg font-semibold leading-normal">5B</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center flex-1 h-20 p-3 ">
            <div class="inline-flex flex-col items-start justify-start">
                ...
                <div class="inline-flex items-end justify-start">
                    <div class="flex space-x-2 items-end justify-start">
                        <p class="text-lg font-semibold leading-normal">$2M</p>
                    </div>
                </div>
            </div>
        </div>
