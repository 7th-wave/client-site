    ...
    <div>
      <div class="lg:grid lg:grid-cols-7 lg:gap-6 rounded-lg">
        <div class="lg:col-span-2">
          ...
          <div
            class="lg:mt-3 bg-white w-full mx-auto sm:max-w-lg md:max-w-lg lg:w-full"
          >
            <img :src="img" class="w-full" alt="" />
          </div>
        </div>
        <div class="mt-5 md:mt-0 lg:col-span-5">
          <div class="box-border max-w-7xl mx-auto">
            <div class="relative bg-white py-8 sm:py-24 lg:pt-8 lg:pb-16">
              <div class="relative">
                <div
                  class="mx-auto max-w-md px-8 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-5xl"
                >
                  <form
                      ...
                      <div>
                        <div class="sm:flex justify-between mt-4">
                                ...
                                <div class="flex items-start">
                                  <div class="h-5 flex items-center">
                                    <input
                                      ...
                                      checked
                                      type="radio"
                                      class="focus:ring-primary-400 h-4 w-4 text-primary-600 border-primary-300"
                                    />
                                  </div>
                          ...
                          <div class="m-8 md:m-0 relative">
                            ...
                            <a
                              href="#"
                              class="absolute inset-0 z-10 bg-white text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-100"
                            >
                              <h1
                                class="text-base bg-gray-600 px-4 py-2 rounded-sm text-white font-medium leading-6 tracking-wider uppercase"
                              >
                                print / save
                              </h1>
                            </a>
      ...
      <auctions
        :nft="data"
        :nft-ref="nftRef"
        :show-auctions="showPanels"
        :no-new-auction="noNewAuction"
      ...
      <sales
        :nft="data"
        :nft-ref="nftRef"
        :show-sales="showPanels"
        :no-new-sale="noNewSale"
        :client-ref="clientRef"
        :address="currentAddress"
      ></sales>
    </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="mt-5 sm:mt-2 sm:flex sm:flex-row-reverse border-t border-gray-300 py-3"
            >
              <a
                href="#"
                @click.prevent="deleteNft()"
                class="uppercase mt-3 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary-400 text-base font-medium text-white hover:bg-primary-600 focus:outline-none sm:ml-3 sm:mt-0 sm:w-auto sm:text-sm"
              >
                Delete
              </a>
              <button
                type="button"
                class="uppercase w-full inline-flex mt-2 lg:mt-0 justify-center rounded-md border border-gray-500 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-black focus:outline-none sm:w-auto sm:text-sm"
